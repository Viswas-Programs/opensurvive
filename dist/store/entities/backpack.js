...
class BackpackSupplier {
    create(minEntity) {
        return new Backpack(minEntity);
    }
}
class Backpack extends entity_1.Entity {
    constructor(minEntity) {
        super(minEntity);
        this.type = Backpack.TYPE;
        this.zIndex = 8;
        this.copy(minEntity);
    }
    copy(minEntity) {
    ...
    render(you, canvas, ctx, scale) {
        ...
        if (!(img === null || img === void 0 ? void 0 : img.complete)) {
            if (!img) {
                ...
                image.src = (0, textures_1.getBackpackImagePath)(this.level);
...
Backpack.backpackImages = Array(3).fill(undefined);
Backpack.TYPE = "backpack";
(() => {
    _1.ENTITY_SUPPLIERS.set(Backpack.TYPE, new BackpackSupplier());
})();
