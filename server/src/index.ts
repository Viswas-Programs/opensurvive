...
server.on("connection", async socket => {
	...
	send(socket, new InitPacket(world.entities, world.obstacles.concat(...world.buildings.map(b => b.obstacles.map(o => o.obstacle))), player, world.playerCount, true));
